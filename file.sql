    ...
    alter table reserva
       ...
       foreign key (quarto_id)
       references quarto
2021-10-29 17:26:12.468  INFO 18340 --- [  restartedMain] o.h.e.t.j.p.i.JtaPlatformInitiator       : HHH000490: Using JtaPlatform implementation: [org.hibernate.engine.transaction.jta.platform.internal.NoJtaPlatform]
2021-10-29 17:26:12.486  INFO 18340 --- [  restartedMain] j.LocalContainerEntityManagerFactoryBean : Initialized JPA EntityManagerFactory for persistence unit 'default'
2021-10-29 17:26:12.625  WARN 18340 --- [  restartedMain] JpaBaseConfiguration$JpaWebConfiguration : spring.jpa.open-in-view is enabled by default. Therefore, database queries may be performed during view rendering. Explicitly configure spring.jpa.open-in-view to disable this warning
    ...
    select
        ...
        categoria6_.nome as nome2_0_4_,
        categoria6_.preco_diaria as preco_di3_0_4_,
    ...
    select
        ...
        categoria0_.preco_diaria as preco_di3_0_0_
    from
